 ...
 */
final class Version20221228161317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_868354CAFB88E14F ON rdv_prestation');
        $this->addSql('ALTER TABLE rdv_prestation DROP utilisateur_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rdv_prestation ADD utilisateur_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_868354CAFB88E14F ON rdv_prestation (utilisateur_id)');
    }
}
